...
- [Problem Statement](#problem-statement)
  - [What Makes Auto-Generated Diagrams Bad](#what-makes-auto-generated-diagrams-bad)
  - [What Makes Hand-Crafted Diagrams Good](#what-makes-hand-crafted-diagrams-good)
  - [The Challenge](#the-challenge)
- [Design Goals](#design-goals)
- [Overall Approach](#overall-approach)
  - [Core Strategy: Inference + Annotations](#core-strategy-inference-annotations)
  - [Output Format](#output-format)
  - [Philosophy](#philosophy)
- [Metadata Requirements](#metadata-requirements)
  - [Entity-Level Metadata](#entity-level-metadata)
  - [Relationship-Level Metadata](#relationship-level-metadata)
  - [Global Metadata](#global-metadata)
  - [Storage Mechanism](#storage-mechanism)
- [Grouping and Layout Strategy](#grouping-and-layout-strategy)
  - [Step 1: Group Formation](#step-1-group-formation)
  - [Step 2: Group Layout (Centrality-Based)](#step-2-group-layout-centrality-based)
  - [Step 3: Within-Group Layout](#step-3-within-group-layout)
  - [Step 4: Inter-Group Connections](#step-4-inter-group-connections)
  - [Constraint: Mermaid Layout Limitations](#constraint-mermaid-layout-limitations)
- [Relationship Visual Vocabulary](#relationship-visual-vocabulary)
  - [Inheritance (IS-A)](#inheritance-is-a)
  - [Composition (HAS-A / Foreign Key)](#composition-has-a-foreign-key)
  - [Association (RELATES-TO / Many-to-Many)](#association-relates-to-many-to-many)
  - [Legend Generation](#legend-generation)
  - [Implementation Note](#implementation-note)
- [Mermaid Generation Process](#mermaid-generation-process)
  - [Phase 1: Model Introspection](#phase-1-model-introspection)
  - [Phase 2: Apply Metadata](#phase-2-apply-metadata)
  - [Phase 3: Generate Mermaid Syntax](#phase-3-generate-mermaid-syntax)
  - [Phase 4: Ensure Determinism](#phase-4-ensure-determinism)
...
- [Key Design Principles](#key-design-principles)
  - [1. Omit Implementation Details](#1-omit-implementation-details)
  - [2. Namespace-Based Grouping](#2-namespace-based-grouping)
  - [3. Multi-Dimensional Hierarchy Challenge](#3-multi-dimensional-hierarchy-challenge)
  - [4. Optimize for Human Perception](#4-optimize-for-human-perception)
  - [5. Determinism Over Cleverness](#5-determinism-over-cleverness)
- [Deferred Decisions](#deferred-decisions)
  - [Annotation Storage Format](#annotation-storage-format)
  - [Mermaid Syntax Choice](#mermaid-syntax-choice)
  - [Layout Algorithm Sophistication](#layout-algorithm-sophistication)
