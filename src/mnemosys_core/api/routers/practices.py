...
@router.delete("/{practice_id}", status_code=status.HTTP_204_NO_CONTENT, response_model=None)
...
@router.delete("/logs/{log_id}", status_code=status.HTTP_204_NO_CONTENT, response_model=None)
