...
def test_create_db_engine_sqlite_with_schema() -> None:
    """Test creating SQLite engine ignores schema configuration."""
    engine = create_db_engine("sqlite:///:memory:", echo=False, database_schema="mnemosys")
